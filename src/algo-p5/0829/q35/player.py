...
class Player:
    ...
    # TODO:battle_vs_bossを定義します。引数はselfのみです。
    def battle_vs_boss(self):
        ...
        なし
        """
        # TODO:"さちさち"という名前のBossCharaクラスのオブジェクトを生成し、変数bossに代入してください。


        # TODO:self.battle()の引数にbossを渡して呼び出してください。
...
if __name__ == '__main__':
    ...
    # TODO:ケビンがボスと戦います。kevin.battle_vs_boss()を呼び出してください。(引数を渡す必要はありません)
