...
import sys
import random
# TODO:「enemyモジュールからEnemyクラスをimportする」構文を、「zako_charaモジュールからZakoCharaクラスをimportする」よう変更してください。
...
if __name__ == '__main__':
    ...
    # 敵のオブジェクトを作成
    # TODO:敵のオブジェクトをEnemyクラスからZakoCharaクラスに変更してください。(代入する変数はenemyのままでいいです。)
    enemy = Enemy("スラスラ")

    # TODO:「(enemy.name)のHPは(enemy.hp)です。」を表示してください。
