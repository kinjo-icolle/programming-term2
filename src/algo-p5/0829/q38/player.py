...
class Player:
    ...
    # TODO:pick_up_plant()メソッドを定義します。引数はselfのみです。
    def pick_up_plant(self):
        ...
        なし
        """
        # TODO:「イベント発生！薬草をみつけた!」を表示してください。


        # TODO:self.plant_numsに1を足して(再代入して)ください。


        # TODO:「(self.name)は薬草を手に入れた!現在薬草を(self.plant_nums)枚持っています。」を表示してください。
