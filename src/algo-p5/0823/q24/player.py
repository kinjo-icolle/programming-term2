...
class Player:
    ...
    def go_forward(self, cells):
        ...
        if event_nm == "BattleVsZako":
            # TODO:一番高い優先順位で、event_nameが"BattleVsZako"の場合の条件判断を追加してください。
            # TODO:Enemyクラスのコンストラクタに、引数"スラスラ"を与え、取得されたオブジェクトを変数zakoに格納してください。

            # TODO:自身とzakoを戦わせて(self.battie(zako)を呼び出して)ください。
