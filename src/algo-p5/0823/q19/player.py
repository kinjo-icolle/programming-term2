import field_map
import sys
# TODO:enemyモジュールからEnemyクラスをimportしてください。
...
if __name__ == '__main__':
    # TODO:プレイヤーの名前を「ケビン」としてPlayerクラスのオブジェクトを変数kevinに代入してください。


    # TODO:kevin.show_status()を呼び出し、プレイヤーの情報を表示してください。


    # TODO:敵の名前を「スラスラ」として、Enemyクラスのオブジェクトを変数enemyに代入してください。


    # TODO:「敵の名前は(enemy.name)、HPは(enemy.hp)です。」の形式で敵の情報を表示してください。
