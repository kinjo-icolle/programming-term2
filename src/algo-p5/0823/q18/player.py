...
class Player:
    def __init__(self, name):
        ...
        self.name = name
        self.cur_pos = 0
        # TODO:ヒットポイントとしてself.hpの初期値に100を代入してください。

        # TODO:最大ヒットポイントとして、self.max_hpの初期値に100を代入してください。

        # TODO:敵に与えるダメージの最小値として、self.min_damageの初期値に4を代入してください。

        # TODO:敵に与えるダメージの最大値値として、self.min_damageの初期値に7を代入してください。

        # TODO:「かいしんのいちげき!」が出る頻度として、self.freqの初期値に20を代入してください。

        # TODO:薬草の数としてself.plant_numsの初期値に10を代入してください。

        # TODO:経験値としてself.expの初期値に0を代入してください。

        # TODO:経験値としてself.levelの初期値に1を代入してください。
    ...
    def show_status(self):
        ...
        """
        # 状態を表示する
        # TODO:現在位置の後に、「、HPは(self.hp)」を追加してください。
        # TODO:最終的に「(self.name)の現在位置は(self.cur.pos)、HPは(self.hp)です。」と表示されるようにしてください。
