...
class Player:
    ...
    def battle(self, enemy):
        ...
        # TODO:このbattle()メソッド内の以降の処理をここに書くとメソッドが長くなるので、以下に定義したget_exp()メソッド内に移動してください。
        # TODO:移動したら、self.get_exp()を呼び出してください。
        # 経験値を1獲得
        self.exp += 1
        print("経験値を1獲得した!")
    ...
    # TODO:get_expメソッドを定義します。引数はselfのみです。
    def get_exp(self):
        """
        経験値を獲得する
        ...
        なし
        """
        # TODO:battle()メソッドの最後にあった経験値取得処理をここに貼り付けてください。
