...
class Player:
    ...
    def show_status(self):
        ...
        # TODO:「経験値を(self.exp)獲得しています。レベルは(self.level)です。」を表示してください。
    ...
    def battle(self, enemy):
        ...
        # TODO:経験値を1獲得します。self.expに1を足して(self.expに再代入して)ください。

        # TODO:「経験値を1獲得した!」を表示してください。


        if self.exp % 10 == 0:
            # TODO:経験値を10獲得するごとにレベルアップします。self.expを10で割った余りが0の場合、self.levelに1を足して(self.levelに再代入して)ください。

            # TODO:最大HPを10上げます。self.max_hpに10を足してください。

            # TODO:敵に与える最小ダメージを1上げます。self.min_damageに1を足してください。

            # TODO:敵に与える最大ダメージを2上げます。self.max_damageに2を足してください。

            # TODO:「(self.name)のレベルが(self.level)に上がった!最大HPが(self.max_hp)になりました。」を表示してください。
