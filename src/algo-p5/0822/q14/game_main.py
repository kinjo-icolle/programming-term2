import field_map
# TODO:fromとimportを用いて、playerというモジュール「から」Playerというクラスを「インポート」インポートしてください
...
if __name__ == '__main__':
    ...
    # TODO:Playerクラスのオブジェクトを変数heroに代入してください。


    # TODO:hero.nameに"たろう"を代入してください。


    # TODO:「やあ、(hero.name)!旅をはじめよう!」の形式で主人公の名前をメッセージ中に表示してください。
